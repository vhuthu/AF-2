...
import com.example.af2.Agrifund_components_viewmodels.repository.AuthRepository
...
class LoginViewModel(
    ...
    //heyi function i thusa uri ri ite user
        ...
        try {
            ...
            repository.createUser(
                ...
                if (isSuccessful) {
                    ...
                    Toast.makeText(context, "User Failed To Login", Toast.LENGTH_SHORT).show()
